const Details = {
  Vata: {
    name: "Vata",
    content: `
      Vata’s elemental makeup consists of air and ether. The common translation of vata is “that which moves things.” 
      Vata is often referred to as the wind in the body, and it is the primary motivating force of the doshas—without it, 
      the other doshas are unable to move.
  ...
  VataKapha: {
    name: "Vata-Kapha",
    content: `
      People with dual constitutions (two doshas) have personalities which are always in a sense “split”: under certain conditions, 
      one dosha will predominate and under other circumstances the other dosha comes to the forefront. 
      The inherent cohesion of personality which characterizes purely Vata, Pitta, or Kapha people is more difficult to come by 
      for those of us who have dual personalities, because we strive to balance the demands of two very dissimilar principles. 
      Most individuals are dual in constitution.
      Qualities: Qualities of both Vata and Kapha doshas
      Balancing Tips: Balancing tips for dual constitution`,
  },
  VataPitta: {
    name: "Vata-Pitta",
    content: `
